...
public class SeleniumHelper {
    ...
    //metoda pozwala ustawic czekanie na element, po dodaniu kontruktora driver mozna usunac z parametrow
    ...
    public void waitForElementToBeDisplayed(By locator) {
        ...
        public static String takeScreenshot(WebDriver driver) throws IOException {
            ...
            File destinationFile = new File("C:\\Users\\laptop\\IdeaProjects\\phptravels\\src\\test\\resources\\screenshots\\" + LocalTime.now().getNano() + ".png");
